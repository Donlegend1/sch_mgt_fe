      ...
      <Container fluid className="main-container">
        <div className="d-flex align-items-center">
          ...
          <div style={{display:'flex', justifyContent:'right',marginRight: "20px"}}>
              {/* <h4  style={{fontWeight:  "bold", fontSize: "20px", marginTop: "10px", marginLeft: "200px", color: "#05A850"}} >HUMAN RESOURCE MANAGEMENT SYSTEM</h4> */}
          </div>
                    ...
                    >
                      <span>
                            {!currentUser?.image ? 
                              ...
                              <>
                              <img
                                  src={process.env.REACT_APP_BACKEND_URL/currentUser?.image}
                                  alt="profile-user"
                                  className="avatar  profile-user brround cover-image"
                                />
                              </>
                      ...
                      <span className=" ms-3 d-none d-lg-block ">
                          <span className="text-dark"><b>{currentUser?.fullname}</b></span>
                        </span>
                    </Dropdown.Toggle>
                    <Dropdown.Menu
                      className="dropdown-menu-end dropdown-menu-arrow"
                    ...
                    >
                      <div className="drop-heading">
                        <div className="text-center">
                          <h5 className="text-dark mb-0">{currentUser?.name}</h5>
                          <small className="text-muted">{currentUser?.user_role}</small>
                        </div>
                      </div>
                      <div className="dropdown-divider m-0"></div>
                      {user.role_id == 2 &&
                      <Dropdown.Item
                        href={`${process.env.PUBLIC_URL}/my-profile`}
                      >
