...
export default function GetEnrollment() {
  ...
  const getSingleEnrollment = async () => {
    ...
    try {
      const res = await endpoint.get(`/profile/show-profile/${params.id}`);
  ...
  return (
    <>
          ...
          <div className="right-col">
            <div className="text-right">
              ...
              <ul className="dotted-list mt-1">
                <li>
                  <span className="mt-3">DATED at Abuja this {formatDate(data.date_of_placement)}</span>
                  <span className="list-item"></span>
                </li>
      ...
      <button onClick={() => window.print()} className="btn btn-primary hideBtn">Print</button>
