            ...
            {!loading &&
              <Card.Body>
                <div className="text-center">
                  {data && <PassportCard image={process.env.REACT_APP_UPLOAD_URL + data.passport_url} />}
                </div>
                <div className="mt-5">
                    ...
                    {data &&
                      ...
                      <div className="col-md-6">
                        ...
                        {/* <div className="row border">
                          ...
                          <div className="col-md-6">
                            {data.year_of_call_to_bar && formatDate(data.year_of_call_to_bar)}
                          </div>
                        </div> */}
                        ...
                        <div className="row border">
                          ...
                          <div className="col-md-6">
                            {data.call_to_bar_cert_dir &&
                              <a href={`${process.env.REACT_APP_UPLOAD_URL + data.call_to_bar_cert_dir}`}
