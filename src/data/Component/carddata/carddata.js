...
//Employeecard1
export function ProfileData({ authJudge }) {
  const [expanded, setExpanded] = React.useState(true);
    ...
    <>
      {show ? (
        <Card className="card bg-primary-gradient">
          <CardActions className="card-header text-white">
            <h3 className="card-title text-white">Profile Information</h3>
            <div className="rtlcards ">
              <ExpandMore
                expand={expanded}
                onClick={handleExpandClick}
            ...
            <CardContent className="card-body text-center">
              ...
              <div className="mb-3">
                <span className="card-text text-white">
                  {authJudge.Title ? authJudge.Title.name : ""}
                </span>
                <br />
                <span className="h4 mb-0 mt-3 text-white">
                  {authJudge.fullname}
                </span>
                <br />

                <span className="h6 mb-0 mt-3 text-white">
                  {"(" +
                    (authJudge.justice ? authJudge.justice.name : "") +
                    ")"}
                </span>
                <br />
                <span className="h4 mb-0 mt-3">
                  {authJudge.Division ? authJudge.Division.name : ""}
                </span>
              </div>
            </CardContent>
            <div className="card-footer text-center text-white">
              <div className="row user-social-detail"></div>
            </div>
          </Collapse>
        </Card>
      ) : null}
...
const useStyles = makeStyles({
  okIcon: {
    backgroundColor: "#0A7E5A", // Green background color
    color: "white", // White text color
    borderRadius: "500%", // Rounded border
    padding: "10px", // Padding around the icon
    fontSize: "80px", // Icon size
  },
});

export function ApplicationData({ handleClickOpen }) {
          ...
          <Collapse
            ...
            <CardContent className="card-body text-center">
              <Link
                ...
                {/* Use flexbox classes to center content horizontally and vertically */}
                {/* <div className="counter-icon bg-primary-gradient box-shadow-primary brround d-flex justify-content-center p-5 mt-4">
                  <i className="fa fa-plane text-white mb-5 " style={{height:"20px"}}></i>
                </div> */}
                <img
                  className="avatar avatar-xxl brround cover-image cover-image mt-3 mb-2"
                  src={"/aero.jpg"}
                  alt=""
                />
              </Link>
              <br />
              <div className="mb-3">
                <span className="h1 mb-0 mt-5">{""}</span>

                <button
                  className="btn btn-outline-success bg-primary" // Use btn-outline-success for green outline
                  onClick={handleShow}>
                  <span className="card-text text-white ">
